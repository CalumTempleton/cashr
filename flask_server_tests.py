...
class TransactionsTestCase(unittest.TestCase):
    ...
    def test_post_transaction_with_valid_data(self):
        ...
        transaction = json.dumps({"date": "2013-11-14", "balance": 100.88,
                                  "category": "beer", "description": "dark fruit",
                                  "value": 2.90})
    ...
    def test_api_can_get_all_transactions(self):
        ...
        transaction_one = json.dumps({"date": "2013-11-14", "balance": 100.88,
                                      "category": "beer", "description": "dark fruit",
                                      "value": 2.90})
        transaction_two = json.dumps({"date": "2019-01-31", "balance": 10.44,
                                      "category": "food", "description": "Weekly shop",
                                      "value": 23.50})
    ...
    def test_post_transaction_with_invalid_date(self):
        ...
        transaction = json.dumps({"date": "Thu, 14 Nov 2013", "balance": 100.88, "category": "beer",
                                  "description": "dark fruit", "value": 2.90})
        res = self.client().post('/add_transaction', data=transaction, headers=HEADERS)
